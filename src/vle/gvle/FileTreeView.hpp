...
public:
	...
	Glib::RefPtr <Gtk::UIManager> getPopupUIManager(){
		return mPopupUIManager;
	}

	Glib::RefPtr <Gtk::ActionGroup> getPopupActionGroup(){
		return mPopupActionGroup;
	}

	std::string getSelectedVpz();
